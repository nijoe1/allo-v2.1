...
contract DonationVotingOnchainWithSablier is BaseStrategy, RecipientsExtension, SablierAllocationExtension {
        ...
        onlyAfterAllocation
    {
        ...
        for (uint256 i; i < _recipientIds.length; i++) {
            ...
            uint256 _stramID = _startSingleStreamDistribution(_recipientAddress, _pool.token, _matchingAmount);
